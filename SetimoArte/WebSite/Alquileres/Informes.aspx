<%@ Page Title="Informes de alquileres" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Informes.aspx.cs" Inherits="WebSite.InformesAlquileres" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="BuscDiv">
        ...
        <ul>
            <li><a href="/Ventas/Informes.aspx">Informe de ventas</a> </li>
        </ul>
    </div>
    <div class="ResDiv">
